...
8.  Configure instance parameters. Choose how to enter your details, via *Form* or *JSON*.
    ...
    *Roles* 
    ...
    -   When as *Plan* you've chosen *integration-flow*, you can either keep the standard role `ESBMessaging.send` or enter a custom role.
        ...
        The default role `ESBMessaging.send` is already predefined. To define a custom role, go to the *Monitor* view of SAP Integration Suite, and select the *User Roles* tile in the *Manage Security* section \(for more information, see [Managing User Roles](../managing-user-roles-4e86f0d.md)\).
