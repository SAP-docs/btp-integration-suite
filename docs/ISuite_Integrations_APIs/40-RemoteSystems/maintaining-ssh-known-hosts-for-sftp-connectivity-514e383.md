...
> ### Tip:  
> To get the host key for a trusted server, you can use the SSH connectivity test. See [SSH Connectivity Tests](../ssh-connectivity-tests-da7dfd0.md).
...
4.  After reviewing the entries and confirming the changes, choose *Deploy*.
