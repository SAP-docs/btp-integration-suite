...
> 
>     For the address of the call, enter the address of the OData API resource and the query options \(see [HTTP Calls and URI Components](../http-calls-and-uri-components-ca75e12.md)\).
> 
>     See: [OData API](../odata-api-a617d6f.md)
> 
