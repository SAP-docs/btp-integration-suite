...
Configure the request from the API client to the Cloud Integration OData API, see [HTTP Calls and URI Components](../http-calls-and-uri-components-ca75e12.md).
