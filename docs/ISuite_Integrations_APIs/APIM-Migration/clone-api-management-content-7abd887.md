...
Once you have your source and target system ready, you can clone your API Management content to the target system by running the Tenant Cloning Tool that you downloaded from [here](https://repo1.maven.org/maven2/com/sap/apimgmt/apim-tct-sdk/3.0.2/apim-tct-sdk-3.0.2.zip).
...
> 
> If you need to regularly move or migrate API Management artifacts between SAP Integration Suite tenants, it is recommended to use the transport capability instead. For more information, see [Transport APIs and Its Related Contents](../transport-apis-and-its-related-contents-eb83118.md).
