...
-   **Analytics Data**
    ...
    -   Custom Metrics and Charts
        ...
        > ### Note:  
        > These entities are not cloned via the cloning tool. You have to create them manually in SAP Integration Suite target system under *Analytics*. For more information, see [Advanced API Analytics](../advanced-api-analytics-5973d4a.md).
