...
EDI Extractor version 2.0 and above supports the TRADACOMS standard and the version 2.3 and above supports the VDA standard \(available only for dedicated service plans, see [2903776](https://me.sap.com/notes/2903776)\).

EDI Extractor supports EDIFACT, EANCOM, ODETTE, TRADACOMS, VDA and ASC-X12 documents.
