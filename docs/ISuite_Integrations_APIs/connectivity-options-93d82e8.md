...
Open Connectors provides you with a catalog of 170+ non-SAP connectors. You can use the *OpenConnectors* adapter to connect SAP Integration Suite tenant with such a connector \(see: [OpenConnectors Receiver Adapter](openconnectors-receiver-adapter-1a27cee.md)\).
...
More information: [Developing Custom Adapters](developing-custom-adapters-7392cc4.md)
