...
# Working with the API Analytics Dashboard

The API analytics dashboard provides a comprehensive view of API performance and errors in the form of charts and KPIs.
