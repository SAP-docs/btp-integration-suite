...
# Discover and Publish APIs from Business Systems
...
To discover the APIs and events from various business systems in Developer Hub, you first need to ask the *Global Account Administrator* to register these systems in the SAP BTP Cockpit.
...
-   Fetch the APIs and events from the respective business systems by selecting the system and accessing the APIs within each system.

    > ### Note:  
    > The SAP S/4HANA APIs are located within the *Consumption Bundles*. A consumption bundle groups together a set of related APIs and events that can be accessed with the same credentials. You can select the consumption bundles to view the APIs contained within them. Furthermore, you can select individual APIs to access their details and documentation.

-   To create products, start by selecting a system from the *Business Systems* page. Then, choose the consumption bundle\(s\) that contain the SAP S/4HANA APIs that you want to publish to the catalog. These consumption bundles can be published as products to make the APIs available in the catalog. You can easily view and manage the products you have created from the *Products* tab. For more information, see [Publish SAP S/4HANA APIs from Business Systems](publish-sap-s-4hana-apis-from-business-systems-08aff91.md).
