...
2.  Search for the messages based on time or other filtering criteria. See [Using IDs to Filter Messages](using-ids-to-filter-messages-a820752.md) and [Using Additional Filter Criteria](using-additional-filter-criteria-6891f9e.md)
...
-   Reinstate Integration Content: You can reinstate integration content by re-importing the previously exported content. See [Backup and Restore Your Integration Artifacts](backup-and-restore-your-integration-artifacts-bd280ef.md)
