<!-- loioe0bb2df56b0c4f2793261c7dbbcd9921 -->
...
> ### Note:  
> If your connection to IBM MQ requires certificate-based authentication along with the JVM parameter - `Dcom.ibm.mq.cfg.useIBMCipherMappings=false`, this configuration is not supported on SAP Cloud Integration. For scenarios that require customizing JVM environment variables to connect to IBM MQ, use Edge Integration Cell. For more details, refer to SAP note [3747955](https://launchpad.support.sap.com/#/notes/3747955).
