...
Shows the runtime profiles where the artifact is deployed. For example, Cloud Integration or Edge Integration Cell. For more information, see [Runtime Profiles](IntegrationSettings/runtime-profiles-8007daa.md) 
