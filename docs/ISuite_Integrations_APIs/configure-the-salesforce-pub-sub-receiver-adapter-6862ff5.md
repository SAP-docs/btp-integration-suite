...
\(Only available when *Authentication* is *OAuth 2.0 Client Credentials* or *OAuth 2.0 Username-Password*\)
...
\(Only available when *Authentication* is *OAuth 2.0 Username-Password*\)
...
\(Only available when *Authentication* is *OAuth 2.0 JWT Bearer*\)
...
\(Only available when *Authentication* is *OAuth 2.0 Client Credentials*\)
