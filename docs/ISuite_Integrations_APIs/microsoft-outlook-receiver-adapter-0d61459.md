...
The Microsoft Outlook Receiver adapter allows you to manage Microsoft Outlook resources such as Calendar, Events, Mail Folders, Attachments, and Messages etc.
...
Example: `/v1.0/users/john.doe@example.com/messages`
...
Enable this checkbox if you want to send the body of the message with the request. For methods GET and DELETE, the body isn't sent by default.
