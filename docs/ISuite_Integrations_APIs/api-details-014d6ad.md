...
[Operations Cockpit API](operations-cockpit-api-da1abc0.md "The Operations Cockpit API lets you monitor your Edge Integration Cell systems using a public Odata API.")
