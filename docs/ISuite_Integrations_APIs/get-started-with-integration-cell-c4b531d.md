<!-- loioc4b531d9e746483eadbafef5ecb15714 -->

# Get Started with Integration Cell

Getting started involves enabling the runtime and using the unified design environment to create, deploy, and manage your API artifacts.

To begin using the Integration Cell runtime:
