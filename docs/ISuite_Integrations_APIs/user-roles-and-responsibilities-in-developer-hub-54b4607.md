...
-   Key Actions for **Admins** in Developer Hub
    ...
    *My Workspace* to perform the following actions on behalf of an application developer:
    ...
    [Creating a Subscription with Developer Hub Administrator Role](https://help.sap.com/viewer/66d066d903c2473f81ec33acfe2ccdb4/Cloud/en-US/df4f777329c744f3a054bddc6011ab6b.html "With the Developer Hub administrator role you can create an subscription for application on behalf of a user (application developer), and view the existing subscription details, and its associated products, custom attributes, and analytics data.") :arrow_upper_right: 
    ...
    *Admin Center* \> *Manage Access* to control the level of access for your users, allowing them to search, discover, and access the content available on Developer Hub.
    ...
    [Manage Access](https://help.sap.com/viewer/66d066d903c2473f81ec33acfe2ccdb4/Cloud/en-US/9df3ecea96b34c5a92ff67d6188470b9.html "As a Developer Hub admin, you have the authority to control the level of access for your users, allowing them to search, discover, and access the content available on Developer Hub.") :arrow_upper_right: 
    ...
    *Admin Center* \> *Manage Content* \> *Configurations* to adjust the visibility of the API Composition navigator on Developer Hub.
    ...
    *Admin Center* \> *Manage Domain Categories* to create domain categories and add the related products into relevant categories.
    ...
    > ### Note:  
    > Additionally, the *AuthGroup.API.Admin* role must be assigned to you to perform the above actions.
...
-   Key Actions for **Application Developers** in Developer Hub
    ...
    > ### Note:  
    > The *AuthGroup.API.ApplicationDeveloper* role collection is assigned by default to a user who gets onboarded to Developer Hub using the Self-registration process or via *Add User* flow.
    ...
    *My Workspace* to create applications, view your applications, monitor costs, and analyze reports.
    ...
    [Creating a Subscription for Application with Application Developer Role](https://help.sap.com/viewer/66d066d903c2473f81ec33acfe2ccdb4/Cloud/en-US/99515fc73df2466b989bf285300860a4.html "As an application developer you can create a subscription for application, and view the existing subscription details, and its associated products, custom attributes and analytics data.") :arrow_upper_right: 
