...
> ### Remember:  
> During Cloud Integration blue-green deployment of worker nodes, connection counts may temporarily double due to the nature of the deployment strategy. This occurs because both old and new worker nodes establish connections simultaneously during the switchover phase. Plan your SAP Integration Suite target system connection thresholds accordingly to avoid connection pool exhaustion errors during new node startup. To proactively manage this, configure connection count alerts on your target systems and ensure your service plan's connection limits can accommodate the temporary spike. JDBC, JMS, AMQP, Microsoft SharePoint, and other database-connected adapters may experience connection saturation when both blue and green environments maintain active pools to shared backend systems.
...
See: [AI Receiver Adapter](ai-receiver-adapter-66e89d2.md)
...
See [BigCommerce Receiver GraphQL Adapter](bigcommerce-receiver-graphql-adapter-3dbf284.md) 
...
See: [Docusign Receiver Adapter](docusign-receiver-adapter-8f3c523.md) 
...
See: [Google BigQuery Receiver Adapter](google-bigquery-receiver-adapter-722ed6c.md)
...
Enables SAP Integration Suite to connect to Google Workspace.

See: [Google Workspace Adapter](google-workspace-adapter-d15c6a5.md)
...
See: [Shopify GraphQL Receiver Adapter](shopify-graphql-receiver-adapter-484c676.md)
...
See: [Shopify REST Receiver Adapter](shopify-rest-receiver-adapter-34865bc.md)
...
Enables SAP Integration Suite to connect to Twilio to perform actions such as sending and receiving messages, managing voice calls, tracking communication status, and automating customer engagement workflows.

See: [Twilio Receiver Adapter](twilio-receiver-adapter-7445ab3.md) 
