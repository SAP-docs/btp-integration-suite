<!-- loio8b4f848e39d344bcb31c15441919985a -->
...
1.  **Governance Settings in Developer Hub** 
    ...
    The Developer Hub administrator \(with the AuthGroup.API.Admin role\), navigates to the *Governance Settings* page on Developer Hub and selects the *Manage Approval Outside Developer Hub* option. For more information, see [Configure Governance Settings for APIs and Events](configure-governance-settings-for-apis-and-events-7446560.md).
