...
-   [Message Stores](https://api.sap.com/api/sap-int-eic-message-store-v1/overview) for Edge Integration Cell
...
> ### Note:  
> Not supported inEdge Integration Cell.
...
`https://<host address>/location/<runtime location id>/api/v1/<relative resource path>`
...
> ### Note:  
> A sandbox environment isn't available for Edge Integration Cell.
