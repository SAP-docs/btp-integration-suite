...
4.  If you want to test the mapping, choose *Simulate* and <span class="SAP-icons-V5"></span>.
...
6.  Choose *Generate* \> *Test*.

    The output XML file data is displayed on the target message table.

7.  If you want to download the output test XML, choose *Download Output*.
