...
2.  Based on the analysis, do one of the following:
    ...
    -   Update your artifact and resolve the non-compliant design guidelines. To resolve non-compliant guidelines of the script, see [Fix Script Incompatibilities](fix-script-incompatibilities-7397c42.md)
