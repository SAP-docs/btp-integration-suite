<!-- loio87ec7982055144d7b2fdea00ad4c92f8 -->

# Synchronize Remote/Third-part MCP Server Changes to Your MCP Server

When the source remote or third-party MCP server undergoes changes, such as added, updated, or removed tools, resources, or prompts, you can synchronize those changes to your MCP server definition. This ensures that your MCP server remains aligned with the latest capabilities exposed by the source MCP server without requiring you to recreate it.



## Prerequisites

-   You have an MCP server created from an Remote/Third-part MCP server artifact. See, [Create an MCP Server Using a Remote MCP Server as the Source](create-an-mcp-server-using-a-remote-mcp-server-as-the-source-742216d.md).
