...
EDI to XML Converter version 2.0 and above supports the TRADACOMS standard and version 2.9 and above supports the VDA standard \(*TRADACOMS* and *VDA* tab; available only for dedicated service plans, see [2903776](https://me.sap.com/notes/2903776)\).
...
> -   From EDI to XML Converter version 2.6 and above, you can use the same XSDs in your SAP Integration Suite tenant as in your SAP Process Integration and SAP Process Orchestration system for the X12 message standard.
> 
> -   From EDI to XML Converter version 2.7 and above, you can use the same XSDs in your SAP Integration Suite tenant as in your SAP Process Integration and SAP Process Orchestration system for VDA message standard.
...
2.  Define the parameters to convert the EDI data format to XML data format.
    ...
    *Source Encoding* 
    ...
    -   Dynamic
        ...
        If selected, the encoding format is set dynamically at runtime using the header `SAP_EDITOXML_VDA_SOURCE_ENCODING` \(possible values: `UTF-8`, `ISO-8859-1`\).
    ...
    *Target Encoding* 
    ...
    Select encoding format for the outgoing payload. If you select *Dynamic*, you must define the value `UTF-8` or `ISO-8859-1` in `SAP_EDITOXML_VDA_TARGET_ENCODING`exchange header.
    ...
    *Conversion Preference* 
    ...
    -   Dynamic
        ...
        If selected, this parameter is set dynamically at runtime using the header `SAP_EDITOXML_VDA_CONVERSION_PREFERENCE` \(possible values: `No`, `Yes`\).
    ...
    *EDI Schema Definition* 
    ...
    -   Dynamic
        ...
        If selected, this parameter is set dynamically at runtime based on the value of the header `SAP_EDITOXML_VDA_SCHEMA_SOURCE` \(possible values: `Header`, `IntegrationProject`\).
