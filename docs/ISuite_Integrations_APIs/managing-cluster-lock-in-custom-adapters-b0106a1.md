...
5.  Once the task is completed, release the lock.
    ...
    **Troubleshooting**
    ...
    Release the lock from monitoring manually. See [Manage Locks for Edge Integration Cell](https://help.sap.com/viewer/caeaa5e76f8c486ebea167938fa1f40b/CLOUD/en-US/8871b61f9e1f473591988e1ad38c8b01.html "This section allows you to display and manage lock entries that are created, to avoid the same message being processed several times in parallel.") :arrow_upper_right:.
