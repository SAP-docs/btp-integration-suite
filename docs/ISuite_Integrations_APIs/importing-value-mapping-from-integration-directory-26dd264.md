...
You can import value mappings from the Integration Directory and view in Cloud Integration.
...
5.  Select the value mappings that you wish to import. You can choose maximum 10 value mappings.

6.  Choose *Next Step*.

7.  In the *Details* tab, you can view the list of value mappings you have selected to import. You can update the name and ID of the mappings. The name of value mapping in the table and in the tenant should be unique.
