...
-   Fault Message Type
    ...
    Allows you to create a Fault Message Type \(See [Creating Fault Message Type](creating-fault-message-type-789b394.md)\)
...
-   Service Interface
    ...
    Allows you to create and configure service interface \(see [Working with Service Interface](working-with-service-interface-fe4b35a.md)\).
