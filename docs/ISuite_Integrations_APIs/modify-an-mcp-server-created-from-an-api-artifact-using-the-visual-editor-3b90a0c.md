...
# Modify an MCP Server Created from an API Artifact using the Visual Editor

After creating an MCP server from an API artifact, you can customize its behavior using the visual editor. Use this tool to efficiently modify your API definitions without manual coding.



## Prerequisites

You have an existing MCP server that needs to be updated. See [Create an MCP Server from an API Artifact](create-an-mcp-server-from-an-api-artifact-9f18140.md).



## Procedure

1.  Go to *Design* \> *Integrations and APIs* and search for the MCP server you want to update.
