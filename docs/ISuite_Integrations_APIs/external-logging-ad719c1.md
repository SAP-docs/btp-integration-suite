...
-   **[Splunk](external-logging-ad719c1.md#loioad719c1c2ecb48b6ba275d2b0ee2ba7a__SPLUNK)**. You can send logs to Splunk through the HTTP Event Collector \(HEC\) API.

-   **[JSON](external-logging-ad719c1.md#loioad719c1c2ecb48b6ba275d2b0ee2ba7a__JSON)**. You can send logs as JSON objects to any HTTP endpoint. For example, you can integrate with custom log processing pipelines.

-   **[OTEL](external-logging-ad719c1.md#loioad719c1c2ecb48b6ba275d2b0ee2ba7a__OTEL)**. You can send logs as OpenTelemetry Protocol \(OTLP\) log records over HTTP to any OTLP-compatible receiver.
...
To access APIs clients, see [Setting Up Inbound HTTP Connections \(for API Clients\)](40-RemoteSystems/setting-up-inbound-http-connections-for-api-clients-8db3d51.md). Create a new role collection and include the following roles: `ExternalLoggingActivationRead` and `ExternalLoggingActivate`.
...
-   [Splunk](external-logging-ad719c1.md#loioad719c1c2ecb48b6ba275d2b0ee2ba7a__SPLUNK)
-   [JSON](external-logging-ad719c1.md#loioad719c1c2ecb48b6ba275d2b0ee2ba7a__JSON)
-   [OTEL](external-logging-ad719c1.md#loioad719c1c2ecb48b6ba275d2b0ee2ba7a__OTEL)
...
> ### Note:  
> Each target system has its own set of additional properties. For more details, see the sections for [Splunk](external-logging-ad719c1.md#loioad719c1c2ecb48b6ba275d2b0ee2ba7a__SPLUNK), [JSON](external-logging-ad719c1.md#loioad719c1c2ecb48b6ba275d2b0ee2ba7a__JSON), and [OTEL](external-logging-ad719c1.md#loioad719c1c2ecb48b6ba275d2b0ee2ba7a__OTEL).
