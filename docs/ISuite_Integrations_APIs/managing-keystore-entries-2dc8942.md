...
2.  Select the target runtime \(*Runtime* parameter\).
    ...
    For more information on how to manage the keystore for Edge Integration Cell, see [Manage Keystore for Edge Integration Cell](https://help.sap.com/viewer/caeaa5e76f8c486ebea167938fa1f40b/CLOUD/en-US/39eb10185fba4dc9945977e493a3d5e8.html "A keystore is used to secure message exchange both at transport level and at message level.") :arrow_upper_right:.
