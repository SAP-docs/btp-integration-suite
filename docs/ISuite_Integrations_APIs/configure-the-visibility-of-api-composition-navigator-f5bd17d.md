<!-- loiof5bd17d682654c01b4b3c8209147a0ea -->

# Configure the Visibility of API Composition Navigator

On this page, you have the option to adjust the visibility of the API Composition navigator on Developer Hub.
...
If the graph feature is activated in the Integration Suite, the *Configure API Composition* setting will be enabled by default in *Manage External Content*, and the *API Composition* option will be displayed in the header. If you want to disable it, you can do so from this page.

If the graph feature is deactivated in the Integration Suite, the *Configure API Composition* setting in *Manage External Content* will be disabled.
