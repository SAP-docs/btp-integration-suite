...
2.  Subscribe to the product that contains the API artifact you want to invoke using a REST client. For more information see, [Subscribe to a Product to Consume APIs and Events in an Application](subscribe-to-a-product-to-consume-apis-and-events-in-an-application-f74f47d.md).
