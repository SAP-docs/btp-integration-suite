...
[Creating an API Artifact](creating-an-api-artifact-c2fe62c.md "API artifacts can be created using different methods depending on your integration scenario and deployment requirements.")
