...
If you have activated Edge Integration Cell, select the target runtime \(*Runtime* parameter\). For more information on how to manage stores for Edge Integration Cell, see [Manage Stores for Edge Integration Cell](https://help.sap.com/viewer/caeaa5e76f8c486ebea167938fa1f40b/CLOUD/en-US/ced47da977824082ac8b2fc78848935d.html "The Manage Stores section allows you to manage various temporary data storages on your selected runtime.") :arrow_upper_right:.
