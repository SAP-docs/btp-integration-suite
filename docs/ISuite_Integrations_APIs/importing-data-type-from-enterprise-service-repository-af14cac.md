<!-- loioaf14cac8149e4f798930655f39003315 -->

# Importing Data Type from Enterprise Service Repository

Import Data Type artifacts from the Enterprise Services \(ES\) Repository.



<a name="loioaf14cac8149e4f798930655f39003315__prereq_tcl_g2x_3xc"/>
...
1.  Navigate to the *Artifacts* tab and choose *Add* \> *Data Type* to add a data type artifact.
...
4.  Choose *Connect*. A list of available data types in ES repository appears.

5.  Select the data type that you wish to import.

6.  Select the *Include Dependent Data Types* checkbox if you wish to include the dependent data type objects while importing the selected data type.
...
7.  Choose *View Summary* to view a summary of all the artifacts to be imported. From the list of objects, you can view the following object status in the *Information* column:
    ...
    -   *Error; ID already exists:* Means that an artifact with the same ID as the selected primary data type already exists in an integration package. Choose *Resolve*, to assign another ID for this artifact. Then, choose *View Summary*.
