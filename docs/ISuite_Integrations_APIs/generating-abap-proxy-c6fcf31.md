...
-   You've the `PI_Integration_Developer` role collection assigned. This role collection already has the required `AuthGroup_IntegrationDeveloper` role. See [Managing User Roles](managing-user-roles-4e86f0d.md) and [Tasks and Permissions for Cloud Integration](60-Security/tasks-and-permissions-for-cloud-integration-556d557.md)

-   A new service instance must be created. See [Creating Service Instance and Service Key for Inbound Authentication](40-RemoteSystems/creating-service-instance-and-service-key-for-inbound-authentication-19af5e2.md)
