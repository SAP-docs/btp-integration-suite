...
> -   EDI Splitter version 2.0 and above supports the TRADACOMS standard and the version 2.12 and above supports the VDA standard \(*TRADACOMS* and *VDA* tab; available only for dedicated service plans, see [2903776](https://me.sap.com/notes/2903776)\).
> 
> -   For EDI Splitter version 2.9 and above, you can use the same XSDs in your SAP Integration Suite tenant as in your SAP Process Integration and SAP Process Orchestration system for X12 message standard.
> 
> -   For EDI Splitter version 2.10 and above, you can use the same XSDs in your SAP Integration Suite tenant as in your SAP Process Integration and SAP Process Orchestration system for VDA message standard.
...
2.  Choose *EDI Splitter* and provide values in property sheet based on the descriptions in the table.
    ...
    *EDI Schema Definition* 
    ...
    3.  Choose *Select* choose the schema\). to add an XML Schema file from the XSD folder found in the integration project.
        ...
        > ### Note:  
        > -   You can also set this field using the header.
        > 
    ...
    *Source Encoding* 
    ...
    -   Dynamic
        ...
        If selected, the encoding format is set dynamically at runtime using the headernullnullnull`SAP_EDISPLITTER_VDA_SOURCE_ENCODING` \(possible values: `UTF-8`, `ISO-8859-1`\).
    ...
    *Split Preference* 
    ...
    Specify the split preference for the VDA message.
    ...
    -   Dynamic
        ...
        If selected, this parameter is set dynamically at runtime using the header `SAP_EDISPLITTER_VDA_SPLIT_PREFERENCE` \(possible values: `NoSplit`, `WithoutValidation`\).
    ...
    *EDI Schema Definition* 
    ...
    -   Dynamic
        ...
        If selected, this parameter is set dynamically at runtime based on the value of the header `SAP_EDISPLITTER_VDA_SCHEMA_SOURCE` \(possible values: `Header`, `IntegrationProject`\).
