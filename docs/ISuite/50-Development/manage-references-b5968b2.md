...
4.  Choose *Add* to upload the files.
    ...
    -   *Script 2.x*: Groovy script 2.x is a future ready script which uses advanced groovy features and utilizes Groovy runtime 4.0.29. For more information about upgrading scripts from 1.x to 2.x see [Upgrading Groovy Script](upgrading-groovy-script-917e014.md)
