...
<a name="task_qjy_45j_yc__prereq_yct_75j_pfc"/>
...
1.  Navigate to the *Artifacts* tab and choose *Add* \> *Service Interface* to add a service interface type.
