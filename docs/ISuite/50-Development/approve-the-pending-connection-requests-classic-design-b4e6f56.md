<!-- loiob4e6f56f448d4e189de65d4ecf90b176 -->
...
[Create a Connection Request for the Centralized API business hub enterprise \[Classic Design\]](create-a-connection-request-for-the-centralized-api-business-hub-enterprise-classic-desig-02f7877.md "To publish the Integration Suite API Management tenant content on the API business hub enterprise, you must create a request to connect the Integration Suite API Management tenant to the API business hub enterprise.")
