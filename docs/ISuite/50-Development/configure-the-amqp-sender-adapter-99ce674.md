...
You use the Advanced Message Queuing Protocol \(AMQP\) sender adapter to consume messages in SAP Integration Suite from queues in an external message broker or from the SAP Event Mesh.
