...
2.  In the *Problems* view, look out for different categories of checks.
    ...
    -   Upgrade Readiness Check: This category includes incompatibilities like usage of unsupported libraries, classes, and unused or duplicate import statements in your scripts. See [Groovy Script](https://help.sap.com/docs/integration-suite/sap-integration-suite/groovy-script?state)
