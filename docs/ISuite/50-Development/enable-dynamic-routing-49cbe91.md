...
2.  Navigate to Integration Suite.

3.  Choose the navigation icon on the left and choose *Design* \> *APIs*.
...
12. Navigate to the *Design* \> *APIs* tab. From the *APIs* list, choose the API proxy that you deployed.
