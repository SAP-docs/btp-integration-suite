...
# Optimize Groovy Scripts with AI
...
3.  GenAI inspects your script and displays the results in a report titled *AI Review Report*. If there's potential for improving your script, this report contains the following sections:
...
> ### Tip:  
> Choose *Download* to save the AI report and the original script to your local file system.
