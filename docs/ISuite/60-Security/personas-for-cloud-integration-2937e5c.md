...
-   Role template `MessagingSend` 
    ...
    More information: [Basic Authentication of IdP User for Integration Flow Processing](https://help.sap.com/viewer/42631d23a21b4178b35c41f971cdd2c9/CLOUD/en-US/5d46e56550a048e99995f23e1e20083a.html "Use this procedure to connect a sender system to SAP Integration Suite using basic authentication of a user registered by an identity provider (IdP).") :arrow_upper_right:
...
> 
> See: [Basic Authentication of IdP User for Integration Flow Processing](https://help.sap.com/viewer/42631d23a21b4178b35c41f971cdd2c9/CLOUD/en-US/5d46e56550a048e99995f23e1e20083a.html "Use this procedure to connect a sender system to SAP Integration Suite using basic authentication of a user registered by an identity provider (IdP).") :arrow_upper_right:
> 
> </td>
> </tr>
> <tr>
...
> 
> -   [Basic Authentication with clientId and clientsecret for Integration Flow Processing](https://help.sap.com/viewer/42631d23a21b4178b35c41f971cdd2c9/CLOUD/en-US/647eeb3eca5d4c299009cacd1332247e.html "Use this procedure to connect a sender system to SAP Cloud Integration.") :arrow_upper_right:
> 
> 
> 
> 
