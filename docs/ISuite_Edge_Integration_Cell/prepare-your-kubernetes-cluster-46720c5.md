...
> ### Note:  
> For information on using a policy controller like Azure Policy, Gatekeeper, or Open Policy Agent \(OPA\), see [Pod Security Standards](pod-security-standards-2557e81.md).
