...
6.  Enter the following properties:
    ...
    **Enable SNC for RFC Adapter**
    ...
    Choose this option to set up SNC for secure communication over the RFC protocol. It is strongly recommended to enable this option if using the RFC adapter productively. For more information, see [Set Up SNC on Edge Integration Cell](set-up-snc-on-edge-integration-cell-c2315d3.md).
