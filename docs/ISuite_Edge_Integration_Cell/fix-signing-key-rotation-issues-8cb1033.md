...
In Edge Integration Cell, you can manually rotate the signing key for access tokens issued by Edge Local Authentication and Authorization. For more information about this functionality, see [Manually Rotate Signing Keys of Access Tokens](manually-rotate-signing-keys-of-access-tokens-0e38815.md).
