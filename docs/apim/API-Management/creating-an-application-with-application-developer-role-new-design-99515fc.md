...
-   You have the *AuthGroup.API.ApplicationDeveloper* role assigned to you. For more information on roles, see [User Roles in API Management](APIM-Initial-Setup/user-roles-in-api-management-911ca5a.md).
