...
6.  After you have copied the API, you can select one of the following two actions for the API:
    ...
    *Not Deployed*
    ...
    API is available only in the , and is not available for product assignments.
...
[Export an API Definition](export-an-api-definition-420abb6.md "Once you create an API in the , you can choose to export it.")
