...
11. Once you’ve filled in all the required details of the API, you can select one of the following two actions for the API:
    ...
    *Not Deployed:*API is available only in the , and isn’t available for product assignments.
...
[Create an API Proxy Using the API Designer](create-an-api-proxy-using-the-api-designer-26e1bbd.md "Model APIs in the Open API format that is available on the .")
