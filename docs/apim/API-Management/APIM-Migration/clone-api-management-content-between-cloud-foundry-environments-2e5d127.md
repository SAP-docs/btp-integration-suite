...
> 
> If you need to regularly move or migrate API Management artifacts between tenants, it is recommended to use the transport capability instead. For more information, see [Transport APIs and Its Related Contents](../transport-apis-and-its-related-contents-eb83118.md).
