...
For OData V2 backend service, API Management generates PUT operation as the default update operation. For OData V4 backend service, API Management generates PATCH operation as the default update operation. However, you can override this by adding the key through the API designer for swagger 2.0 or Open API 3.0:
