...
Personas cover the different tasks associated with an integration project. To assign the applicable role collections for a user, see [Configuring User Access to SAP Integration Suite](https://help.sap.com/viewer/51ab953548be4459bfe8539ecaeee98d/CLOUD/en-US/2c6214a3228e4b4cba207f49fda92ed4.html "Assign the required roles and role collections to users for accessing the individual capabilities.") :arrow_upper_right:.
