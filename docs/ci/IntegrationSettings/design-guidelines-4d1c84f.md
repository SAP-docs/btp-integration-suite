...
In the past, these design guidelines were recommendations that were published as product help and prepackaged content on SAP Business Accelerator Hub. You can find the guidelines in the [Integration Flow Design Guidelines](../Development/integration-flow-design-guidelines-6803389.md) section. Now, the same guidelines are embedded within the software as rules that help integration developers.
...
For more information on how integration developers can validate their artifacts, see [Design Guidelines View](../Development/design-guidelines-view-d62dfe0.md).
...
[Integration Flow Design Guidelines](../Development/integration-flow-design-guidelines-6803389.md "As an integration developer, you need to make sure that you design integration flows in a robust fashion in order to safeguard your company's mission-critical business processes.")
