...
1.  Choose *Edit*.
    ...
    > ### Note:  
    > Ensure that the MAG you want to edit isn't **locked** by other users. The *Locked By* field displays the ID of the user who's currently editing the MAG. To unlock a MAG, you need admin rights. To learn more about the role, see [Assigning Users for SAP Integration Advisor](assigning-users-for-sap-integration-advisor-b5226b9.md) .
...
3.  In the *Mapping* tab, you can edit the mapping details of the MAG. For more information on mapping nodes, see [Mapping the Source and Target Nodes](mapping-the-source-and-target-nodes-9ea58d6.md).
    ...
    -   The *mapping list* displays all the relevant information of the source and target nodes such as source nodes, target nodes, their cardinality and so on. The *Type* column displays the type of each entry in the mapping list. You can filter and view the mappings that are erroneous and mappings that have proposals using the drop-down filter available above the mapping list table.
        ...
        To **delete** one or more mappings from the list, select them and choose *Delete*.
...
[Simulating Mapping Guidelines](simulating-mapping-guidelines-b18178b.md "Learn how to simulate a mapping guideline.")

 <?sap-ot O2O class="- topic/link " href="1891fea318aa41bfa19b00b365f7e4d9.xml" text="" desc="" xtrc="link:5" xtrf="file:/home/builder/src/dita-all/zpk1713331951414/loio3268cb35959d4b368fb49de861bfe8a1_en-US/src/content/localization/en-us/0803ca6cde694cea8daa71c2530c9cbc.xml" output-class="" outputTopicFile="file:/home/builder/tp.net.sf.dita-ot/2.3/plugins/com.elovirta.dita.markdown_1.3.0/xsl/dita2markdownImpl.xsl" ?> 
