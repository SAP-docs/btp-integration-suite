...
> ### Note:  
> Currently, Integration Advisor supports exporting runtime artifacts for SAP Cloud Integration and SAP Process Orchestration.
> 
...
> ### Note:  
> This property only applies to EDI type systems \(for example, `ASC X12`, `UN/EDIFACT`, `ODETTE`, `TRADACOMS`, or VDA\).
