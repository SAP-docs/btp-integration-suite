...
To create and edit access policies, your user must be assigned the authorization group *AuthGroup.Administrator* \(Neo environment\).

To create and edit access policies, your user must be assigned the role collection *PI\_Administrator* \(Cloud Foundry environment\).
...
3.  Provide the following details:
    ...
    *Role Name*
    ...
    \(Neo environment\) The role name is the name of the associated custom role that you've to create in your subaccount \(see [Creating Custom Roles for Access Policies, Neo Environment](creating-custom-roles-for-access-policies-neo-environment-18f06d4.md)\).

    \(Cloud Foundry environment\) When creating the associated custom role in your subaccount, make sure that you specify the same string under *Values* \(see [Creating Custom Roles for Access Policies, Cloud Foundry Environment](creating-custom-roles-for-access-policies-cloud-foundry-environment-7db3c87.md)\).
