...
-   Check if the maximum file size is very large, such as hundreds of MB or even GB. If it is, consider processing smaller messages. For more information, see Disk Space in [System Scope in the Cloud Foundry Environment](../WhatIsCloudIntegration/system-scope-in-the-cloud-foundry-environment-8ea3822.md) .
