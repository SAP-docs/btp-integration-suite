...
Integration flows can use *Data Store Operations* steps to store data in local or global data stores at runtime \(see [Data Storages](../Development/data-storages-31efe35.md)\).
