...
Operations you can perform on the deployed artifact under *Monitor* \> *Manage Integration Content* \(such like restarting or undeploying the artifact or changing the log level for monitoring\)
