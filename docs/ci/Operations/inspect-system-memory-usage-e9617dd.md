...
The blue bar chart shows the message load for a defined time period:![](images/Inspect_Memory_Usage_21a01f3.png)
...
The red bar chart shows the time periods when heap memory was exhausted:![](images/Memory_Exhaustoin_e984c9c.png)
...
Choose a bar or bullet to get more context information including the precise timestamp, message process log count, and the count of memory exhaustion events \(shown in error state when the count is greater than 0\).
...
-   General integration flow design measures
    ...
    More information: [Optimize Memory Footprint](../Development/optimize-memory-footprint-dc24074.md)
...
-   *Splitter* step
    ...
    More information: [Reduce the Memory Consumption for Splitter Scenarios](../Development/reduce-the-memory-consumption-for-splitter-scenarios-de974b8.md)
