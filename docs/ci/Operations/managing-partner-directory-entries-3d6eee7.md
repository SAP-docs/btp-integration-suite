...
> 
> For more comprehensive details on the concept and entities stored in the Partner Directory, see [Parameterizing Integration Flows Using the Partner Directory](../Development/parameterizing-integration-flows-using-the-partner-directory-b7812a5.md)
> 
> To view examples of integration flows using the Partner Directory, consult the integration flow design guidelines at [Use the Partner Directory Appropriately](../Development/use-the-partner-directory-appropriately-6e00412.md).
> 
> You can also use the Cloud Integration OData API to create, edit, and display the content of the Partner Directory \(see: [Partner Directory](../Development/partner-directory-0fe80dc.md)\).
