<!-- loiocaad46863bdf43539324ced576728e66 -->
...
Cloud Integration \(Neo environment; runtime based on Apache Camel version 3.\*\)
...
Cloud Integration \(Neo environment; runtime based on Apache Camel 2.\*\)
