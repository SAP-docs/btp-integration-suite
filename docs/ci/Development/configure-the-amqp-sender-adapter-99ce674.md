...
You use the Advanced Message Queuing Protocol \(AMQP\) sender adapter to consume messages in SAP Cloud Integration from queues in an external message broker or from the SAP Event Mesh.
