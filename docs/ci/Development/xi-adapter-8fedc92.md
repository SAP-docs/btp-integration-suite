...
The XI sender adapter allows you to connect a tenant to a local Integration Engine in a sender system. And the XI receiver adapter allows you to connect it to a sender system. The adapter supports communication over the XI 3.0 protocol, including support for any message type to be exchanged via the XI protocol.
