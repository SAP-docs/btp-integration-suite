...
Security artifacts are the credentials needed to connect to an external system.See [Naming Conventions](naming-conventions-7c00e9b.md).
...
See: [Managing User Roles, Cloud Foundry Environment](../Operations/managing-user-roles-cloud-foundry-environment-4e86f0d.md) and [Creating Custom Roles for Access Policies, Cloud Foundry Environment](../Operations/creating-custom-roles-for-access-policies-cloud-foundry-environment-7db3c87.md).
