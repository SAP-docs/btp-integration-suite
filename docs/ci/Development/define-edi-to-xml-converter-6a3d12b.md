...
Use this procedure to convert EDIFACT, ODETTE, and ASC-X12 format into XML format.
...
> -   For X12 format, EDI to XML converter v1.8.0 onwards supports same group name with different definition in XSD.
> -   From EDI to XML Converter version 2.6 and above, you can use the same XSDs in your tenant as in your SAP Process Integration and SAP Process Orchestration system for the X12 message standard.
> 
> -   From EDI to XML Converter version 2.7 and above, you can use the same XSDs in your tenant as in your SAP Process Integration and SAP Process Orchestration system for VDA message standard.
