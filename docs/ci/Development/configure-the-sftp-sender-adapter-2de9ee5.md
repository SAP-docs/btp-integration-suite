...
The system uses locks to ensure that each file from the SFTP server is only processed on one runtime node \(see: [Message Locks](../Operations/message-locks-bce9ae0.md)\).
