...
Represents an *OAuth2 Client Credentials* artifact \(see [Deploying an OAuth2 Client Credentials Artifact](../Operations/deploying-an-oauth2-client-credentials-artifact-801b106.md)\).
