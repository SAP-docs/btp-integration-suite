...
To authorize an API client to access the OData API, perform the steps described in [Setting Up Inbound HTTP Connections \(for API Clients\)](../ConnectionSetup/setting-up-inbound-http-connections-for-api-clients-8db3d51.md) in the Cloud Foundry environment.
