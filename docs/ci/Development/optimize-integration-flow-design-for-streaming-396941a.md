...
For an overview of the available resources of SAP Cloud Integration tenants deployed in the Cloud Foundry environment, see[System Scope for Cloud Integration in the Cloud Foundry Environment](../WhatIsCloudIntegration/system-scope-in-the-cloud-foundry-environment-8ea3822.md).

For an overview of the available resources of SAP Cloud Integration tenants deployed in the Neo environment, see: [System Scope in the Neo Environment](../WhatIsCloudIntegration/system-scope-in-the-neo-environment-4ef131c.md).

To monitor the total storage used by temporary files, see [Inspect Temporary Storage](../Operations/inspect-temporary-storage-7cdfaa7.md).
