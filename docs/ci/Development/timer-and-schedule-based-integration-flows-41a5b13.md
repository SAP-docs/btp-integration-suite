...
This section describes how to design and operate schedule‑based integration flows in SAP . This is applicable for certain sender components, particularly timers, and in built schedule feature in polling adapters \(SFTP and FTP\) have best effort quality of service.



## Context

SAP runs on a multi‑node worker runtime.
...
For details about the underlying architecture, see [Technical Landscape, Cloud Foundry Environment](../SecurityCF/technical-landscape-cloud-foundry-environment-cc22301.md) and [Integration Flow Deployed on Multiple Worker Nodes](integration-flow-deployed-on-multiple-worker-nodes-4ffa6f7.md) 
...
Timer and scheduler‑initiated integration flows in SAP are cluster‑aware and best‑effort by design.
