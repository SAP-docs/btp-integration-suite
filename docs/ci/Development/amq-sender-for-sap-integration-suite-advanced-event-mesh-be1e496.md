...
Enables SAP Cloud Integration to consume messages from queues in , advanced event mesh.
...
To connect SAP Cloud Integration to , advanced event mesh, make sure to specify the following parameters in the described way.
