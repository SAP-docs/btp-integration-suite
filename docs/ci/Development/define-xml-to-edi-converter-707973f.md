...
2.  Define the parameters to convert the XML data format to EDI data format.
    ...
    > 
    > -   For X12 format, XML to EDI converter v1.3.0 onwards supports same group name with different definition in XSD.
    > -   For XML to EDI Converter version 2.6 and above, you can use the same XSDs in your tenant as in your SAP Process Integration and SAP Process Orchestration system.
