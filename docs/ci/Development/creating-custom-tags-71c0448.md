...
> ### Remember:  
> You must have the tenant administrator role assigned to access the *Custom Tags* settings. See [Tasks and Permissions](../SecurityNeo/tasks-and-permissions-556d557.md).
