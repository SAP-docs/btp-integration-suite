...
For more information, check out [Client Certificate Authentication \(Inbound\), Cloud Foundry Environment](client-certificate-authentication-inbound-cloud-foundry-environment-4ec6192.md) \(explains the concepts and how this authentication option works\).
...
Configure the request from the API client to the Cloud Integration OData API \(see [HTTP Calls and URI Components](../Development/http-calls-and-uri-components-ca75e12.md)\).
