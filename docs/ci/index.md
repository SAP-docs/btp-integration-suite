...
-   [SAP Cloud Integration](sap-cloud-integration-2fb0aa4.md)
    -   [What Is SAP Cloud Integration?](WhatIsCloudIntegration/what-is-sap-cloud-integration-e12c09c.md)
        ...
        -   [System Scope in the Cloud Foundry Environment](WhatIsCloudIntegration/system-scope-in-the-cloud-foundry-environment-8ea3822.md)
        -   [System Scope in the Neo Environment](WhatIsCloudIntegration/system-scope-in-the-neo-environment-4ef131c.md)
    ...
    -   [What's New for Cloud Integration](WhatsNewInCloudIntegration/sap-cloud-integration-72ef31d.md)
        -   [Patch Releases for Cloud Integration](WhatsNewInCloudIntegration/patch-releases-for-cloud-integration-023a472.md)
            -   [Understanding Software Version Numbers](WhatsNewInCloudIntegration/understanding-software-version-numbers-caad468.md)
        ...
        -   [Archive - Release Notes for SAP Cloud Integration](WhatsNewInCloudIntegration/archive-release-notes-for-sap-cloud-integration-bbe2dac.md)
            -   [2025 What's New for SAP Cloud Integration \(Archive\)](WhatsNewInCloudIntegration/2025-what-s-new-for-sap-cloud-integration-archive-d0dcc5b.md)
            -   [2024 What's New for SAP Cloud Integration \(Archive\)](WhatsNewInCloudIntegration/2024-what-s-new-for-sap-cloud-integration-archive-14d169b.md)
            -   [2023 What's New for SAP Cloud Integration \(Archive\)](WhatsNewInCloudIntegration/2023-what-s-new-for-sap-cloud-integration-archive-d2f33cd.md)
    ...
    -   [Integration Advisor](what-s-new-for-integration-advisor-756eb36.md)
    -   [Initial Setup](InitialSetup/initial-setup-0a556d5.md)
        ...
        -   [Initial Setup of SAP Cloud Integration in the Kyma Environment](InitialSetup/initial-setup-of-sap-cloud-integration-in-the-kyma-environment-ed8046d.md)
        -   [Environment-Specific Aspects Integration Developers Should Know](InitialSetup/environment-specific-aspects-integration-developers-should-know-639a061.md)
            ...
            -   [IP Allowlisting for Inbound Requests](InitialSetup/ip-allowlisting-for-inbound-requests-17de0b0.md)
        ...
        -   [Configuring Inbound Communication](ConnectionSetup/configuring-inbound-communication-62690e5.md)
            -   [Configuring Inbound HTTP Connections, Cloud Foundry Environment](ConnectionSetup/configuring-inbound-http-connections-cloud-foundry-environment-f568400.md)
                ...
                -   [Creating Service Instance and Service Key for Inbound Authentication](ConnectionSetup/creating-service-instance-and-service-key-for-inbound-authentication-19af5e2.md)
                    ...
                    -   [Update Service Instance that Contains Deprecated client\_x509 Grant Type](ConnectionSetup/update-service-instance-that-contains-deprecated-client-x509-grant-type-0a38373.md)
                ...
                -   [Setting Up Inbound HTTP Connections \(for API Clients\)](ConnectionSetup/setting-up-inbound-http-connections-for-api-clients-8db3d51.md)
                    ...
                    -   [Basic Authentication with clientId and clientsecret for API Clients](ConnectionSetup/basic-authentication-with-clientid-and-clientsecret-for-api-clients-db55f0d.md)
        ...
        -   [Concepts of Secure Communication](ConnectionSetup/concepts-of-secure-communication-3545808.md)
            -   [Basics](ConnectionSetup/basics-36839ad.md)
                ...
                -   [SFTP-Based Communication](ConnectionSetup/sftp-based-communication-f1a9be1.md)
                    -   [How SFTP Works](ConnectionSetup/how-sftp-works-fc8467b.md)
    ...
    -   [Development](Development/development-78d23d4.md)
        ...
        -   [Developing Integration Content with SAP Cloud Integration](Development/developing-integration-content-with-sap-cloud-integration-e6b43b4.md)
            ...
            -   [Content Transport](Development/content-transport-e3c79d6.md)
                ...
                -   [Handling Integration Artifacts across Multiple Tenants](Development/handling-integration-artifacts-across-multiple-tenants-2a1d598.md)
            ...
            -   [Configure Integration Flow Components](Development/configure-integration-flow-components-3171795.md)
                ...
                -   [Define Settings for the Integration Flow](Development/define-settings-for-the-integration-flow-3a6446c.md)
                    ...
                    -   [Manage References](Development/manage-references-b5968b2.md)
                    ...
                    -   [Design Guidelines View](Development/design-guidelines-view-d62dfe0.md)
                ...
                -   [Configure Adapter in Communication Channels](Development/configure-adapter-in-communication-channels-1f06633.md)
                    -   [AMQP Adapter](Development/amqp-adapter-5cc1a71.md)
                        -   [Configure the AMQP Sender Adapter](Development/configure-the-amqp-sender-adapter-99ce674.md)
                            ...
                            -   [AMQ Sender for SAP Integration Suite, advanced event mesh](Development/amq-sender-for-sap-integration-suite-advanced-event-mesh-be1e496.md)
                        -   [Configure the AMQP Receiver Adapter](Development/configure-the-amqp-receiver-adapter-d5660c1.md)
                            ...
                            -   [AMQP Receiver for SAP Integration Suite, advanced event mesh](Development/amqp-receiver-for-sap-integration-suite-advanced-event-mesh-5f229c0.md)
                        -   [Supported Settings for Specific Message Brokers](Development/supported-settings-for-specific-message-brokers-059bd96.md)
                    ...
                    -   [AS4 Sender Adapter](Development/as4-sender-adapter-a448605.md)
                        ...
                        -   [Configure the Sender Channel with ebMS3 Receipt](Development/configure-the-sender-channel-with-ebms3-receipt-428ae65.md)
                    -   [AS4 Receiver Adapter](Development/as4-receiver-adapter-3a2fde8.md)
                        -   [Configure Receiver Channel with ebMS3 Pull](Development/configure-receiver-channel-with-ebms3-pull-7cdde30.md)
                        -   [Configure Receiver Channel with ebMS3 Push](Development/configure-receiver-channel-with-ebms3-push-449f6e9.md)
                    ...
                    -   [FTP Adapter](Development/ftp-adapter-4464f89.md)
                        ...
                        -   [Configure the FTP Sender Adapter Used with the Poll Enrich Step](Development/configure-the-ftp-sender-adapter-used-with-the-poll-enrich-step-3eca3f8.md)
                    ...
                    -   [JDBC Receiver Adapter](Development/jdbc-receiver-adapter-88be644.md)
                        ...
                        -   [JDBC for MariaDB \(Cloud\)](Development/jdbc-for-mariadb-cloud-1d320d6.md)
                    ...
                    -   [RFC Receiver Adapter](Development/rfc-receiver-adapter-5c76048.md)
                        ...
                        -   [Creating and Modifying RFC Destination](Development/creating-and-modifying-rfc-destination-3b55fa7.md)
                    ...
                    -   [SFTP Adapter](Development/sftp-adapter-e3dce88.md)
                        -   [Configure the SFTP Sender Adapter](Development/configure-the-sftp-sender-adapter-2de9ee5.md)
                            -   [Integration Flow Deployed on Multiple Worker Nodes](Development/integration-flow-deployed-on-multiple-worker-nodes-4ffa6f7.md)
                ...
                -   [Working with Mapping](Development/working-with-mapping-68d816a.md)
                    -   [Message Mapping](Development/message-mapping-459ccdf.md)
                        ...
                        -   [Simulate Message Mapping](Development/simulate-message-mapping-2718106.md)
                    ...
                    -   [Importing Value Mapping from Integration Directory](Development/importing-value-mapping-from-integration-directory-26dd264.md)
                    -   [Configuring Value Mapping](Development/configuring-value-mapping-40c1827.md)
                ...
                -   [Working with Script and Script Collection](Development/working-with-script-and-script-collection-e60f706.md)
                    -   [Creating a Script Collection](Development/creating-a-script-collection-824bff0.md)
                        ...
                        -   [Design Guidelines View for Script Collection](Development/design-guidelines-view-for-script-collection-f009d45.md)
                    -   [Define a Local Script Step](Development/define-a-local-script-step-03b32eb.md)
                        -   [Fix Script Incompatibilities](Development/fix-script-incompatibilities-7397c42.md)
                ...
                -   [Define Message Transformer Steps](Development/define-message-transformer-steps-e223071.md)
                    ...
                    -   [Define XML to JSON Converter](Development/define-xml-to-json-converter-a60a282.md)
                        -   [Limitations for XML-to-JSON Conversion](Development/limitations-for-xml-to-json-conversion-a5b4641.md)
                        -   [Conversion Rules for XML to JSON Conversion](Development/conversion-rules-for-xml-to-json-conversion-778aed7.md)
        ...
        -   [Developing Custom Adapters](Development/developing-custom-adapters-7392cc4.md)
            ...
            -   [Adapter Development Process](Development/adapter-development-process-e600fd7.md)
                ...
                -   [Consuming Non-OSGi Jar](Development/consuming-non-osgi-jar-0b4364a.md)
                ...
                -   [Managing Cluster Lock in Custom Adapters](Development/managing-cluster-lock-in-custom-adapters-b0106a1.md)
                -   [Enabling ADK Persistency](Development/enabling-adk-persistency-958480b.md)
        ...
        -   [API Documentation](Development/api-documentation-3fd9fc9.md)
            ...
            -   [OData API](Development/odata-api-a617d6f.md)
                -   [API Details](Development/api-details-014d6ad.md)
                    -   [Integration Content](Development/integration-content-d1679a8.md)
                        ...
                        -   [Integration Content Example Requests](Development/integration-content-example-requests-60cc8f1.md)
                            ...
                            -   [Update and Validate Configuration Parameters](Development/update-and-validate-configuration-parameters-2b92d3d.md)
                    ...
                    -   [B2B Scenarios](Development/b2b-scenarios-56ccf98.md)
                ...
                -   [Addressing the CISUsers Entity \(for User Creation\)](Development/addressing-the-cisusers-entity-for-user-creation-d732274.md)
                -   [Local OData API Access for Edge Integration Cell](Development/local-odata-api-access-for-edge-integration-cell-a17fa4d.md)
        -   [Integration Flow Design Guidelines](Development/integration-flow-design-guidelines-6803389.md)
            ...
            -   [Learn the Basics](Development/learn-the-basics-ebc6034.md)
                ...
                -   [Handle IDoc Bulk Messages](Development/handle-idoc-bulk-messages-e35e389.md)
            ...
            -   [Guidelines to Design Enterprise-Grade Integration Flows](Development/guidelines-to-design-enterprise-grade-integration-flows-a8cd981.md)
                -   [Ensure Upgrade Readiness](Development/ensure-upgrade-readiness-6adb0ca.md)
                    -   [Scripts](Development/scripts-fa29f02.md)
                        -   [Use Recommended Libraries and Classes](Development/use-recommended-libraries-and-classes-bbba19d.md)
                        -   [Include Only Used Import Statements](Development/include-only-used-import-statements-1220ae1.md)
                        -   [Access Resources Appropriately](Development/access-resources-appropriately-1ffeb94.md)
                        -   [Ensure Valid Syntax](Development/ensure-valid-syntax-afab3a1.md)
                        -   [Use Import Statements Supported by the Script Runtime](Development/use-import-statements-supported-by-the-script-runtime-13fee7f.md)
                        -   [Restrict Usage to Supported Frameworks and Libraries](Development/restrict-usage-to-supported-frameworks-and-libraries-d8a70aa.md)
                -   [Timer and Schedule based Integration Flows](Development/timer-and-schedule-based-integration-flows-41a5b13.md)
                -   [Run an Integration Flow Under Well-Defined Boundary Conditions](Development/run-an-integration-flow-under-well-defined-boundary-conditions-f8cf974.md)
                    -   [Limit Size of Deployed Integration Content](Development/limit-size-of-deployed-integration-content-417f82b.md)
                ...
                -   [Relax Dependencies to External Components](Development/relax-dependencies-to-external-components-3ea1e33.md)
                    -   [Apply the Retry Pattern](Development/apply-the-retry-pattern-97789c9.md)
                        -   [Apply the Retry Pattern in the Sender Applications](Development/apply-the-retry-pattern-in-the-sender-applications-0e27ac9.md)
            ...
            -   [Guidelines to Implement Specific Integration Patterns](Development/guidelines-to-implement-specific-integration-patterns-eaf929e.md)
                ...
                -   [Quality of Service](Development/quality-of-service-2b9acb2.md)
                    ...
                    -   [Quality of Service Exactly Once In Order](Development/quality-of-service-exactly-once-in-order-e1ef22e.md)
                        -   [Generic Use Case](Development/generic-use-case-70c7774.md)
                        -   [Sender with XI Protocol and Receiver with SAP RM Protocol](Development/sender-with-xi-protocol-and-receiver-with-sap-rm-protocol-090abf3.md)
                        -   [Sender with SAP RM Protocol and Receiver with XI Protocol](Development/sender-with-sap-rm-protocol-and-receiver-with-xi-protocol-5f35b5c.md)
                        -   [SFTP Sender Scenario](Development/sftp-sender-scenario-3d7fd37.md)
                        -   [Decoupling Using SAP Integration Suite, Advanced Event Mesh](Development/decoupling-using-sap-integration-suite-advanced-event-mesh-df7b472.md)
                        -   [IDoc Sender Scenario](Development/idoc-sender-scenario-7266628.md)
    ...
    -   [Security, Cloud Foundry Environment](SecurityCF/security-cloud-foundry-environment-eb9923e.md)
        ...
        -   [Security Aspects of Data, Data Flow](SecurityCF/security-aspects-of-data-data-flow-7895724.md)
        -   [Identity and Access Management](SecurityCF/identity-and-access-management-f805b22.md)
            -   [Personas](SecurityCF/personas-4b4ba1c.md)
        ...
        -   [Rate Limits on SAP Cloud Integration](SecurityCF/rate-limits-on-sap-cloud-integration-4cac4a4.md)
    ...
    -   [Operating and Monitoring Cloud Integration](Operations/operating-and-monitoring-cloud-integration-c401afc.md)
        ...
        -   [Monitor](Operations/monitor-05446d0.md)
            -   [Monitor with AI](Operations/monitor-with-ai-0f656c7.md)
                -   [AI-assisted Error Resolution](Operations/ai-assisted-error-resolution-f27f95d.md)
            -   [Monitor Message Status Overview](Operations/monitor-message-status-overview-0cde046.md)
            ...
            -   [Manage Security](Operations/manage-security-6e7c44c.md)
                -   [Managing Security Material](Operations/managing-security-material-b8ccb53.md)
                    ...
                    -   [Deploying an OAuth2 Password Credentials](Operations/deploying-an-oauth2-password-credentials-37c919d.md)
                ...
                -   [Managing Access Policies](Operations/managing-access-policies-318d107.md)
                    -   [Access Policies](Operations/access-policies-e0009f3.md)
                    -   [Access Policies Examples](Operations/access-policies-examples-f1dc1a7.md)
                    -   [Defining Access Policies](Operations/defining-access-policies-b0d7950.md)
            ...
            -   [Manage Stores](Operations/manage-stores-59f8e3a.md)
                ...
                -   [Managing Partner Directory Entries](Operations/managing-partner-directory-entries-3d6eee7.md)
                    -   [Partner Directory Entity Types](Operations/partner-directory-entity-types-950f4b2.md)
                    -   [Add Partner](Operations/add-partner-414b97d.md)
                    -   [Delete Partner](Operations/delete-partner-83a9bfd.md)
                    -   [Create Partner Directory Entity](Operations/create-partner-directory-entity-f41418f.md)
                    -   [Edit Partner Entity](Operations/edit-partner-entity-858af76.md)
                    -   [Copy Partner Entity](Operations/copy-partner-entity-d110a04.md)
                    -   [Delete Partner Entity](Operations/delete-partner-entity-25aed52.md)
        ...
        -   [Inspect](Operations/inspect-a4d5e49.md)
            -   [Inspect Data Store Usage](Operations/inspect-data-store-usage-fcc08f6.md)
                -   [Inspect Top Data Stores by Usage](Operations/inspect-top-data-stores-by-usage-55670e6.md)
                -   [Inspect Top Data Stores by Message Size](Operations/inspect-top-data-stores-by-message-size-00431bf.md)
            -   [Inspect Database Connection Usage](Operations/inspect-database-connection-usage-567eb42.md)
                ...
                -   [Inspect Top Integration Flows with Failed Connection Attempts](Operations/inspect-top-integration-flows-with-failed-connection-attempts-5d9d214.md)
            ...
            -   [Inspect System Memory Usage](Operations/inspect-system-memory-usage-e9617dd.md)
                -   [Inspect Integration Flows By System Memory Usage](Operations/inspect-integration-flows-by-system-memory-usage-2a2e1f2.md)
            -   [Inspect Content Size](Operations/inspect-content-size-f72b7ff.md)
            -   [Inspect Temporary Storage](Operations/inspect-temporary-storage-7cdfaa7.md)
                -   [Inspect Top Integration Flows by Storage Usage](Operations/inspect-top-integration-flows-by-storage-usage-9183e3b.md)
            -   [Inspect Top Consuming Integration Flows](Operations/inspect-top-consuming-integration-flows-c8fd522.md)
            -   [Inspect Resource Consumption for Individual Integration Flow](Operations/inspect-resource-consumption-for-individual-integration-flow-3380bd6.md)
    ...
    -   [SAP Integration Advisor](IntegrationAdvisor/sap-integration-advisor-6b9fe2d.md)
        ...
        -   [Custom Type Systems](IntegrationAdvisor/custom-type-systems-884bb25.md)
            ...
            -   [Adding a Custom Codelist](IntegrationAdvisor/adding-a-custom-codelist-fa0c76f.md)
            -   [Deleting a Custom Message](IntegrationAdvisor/deleting-a-custom-message-e6abb6e.md)
            -   [Deleting a Custom Codelist](IntegrationAdvisor/deleting-a-custom-codelist-01ad9ee.md)
        ...
        -   [Message Implementation Guidelines \(MIGs\)](IntegrationAdvisor/message-implementation-guidelines-migs-f9f2bab.md)
            -   [Creating Message Implementation Guidelines](IntegrationAdvisor/creating-message-implementation-guidelines-b894de0.md)
                -   [Creating Message Implementation Guidelines by Payload](IntegrationAdvisor/creating-message-implementation-guidelines-by-payload-74b67f9.md)
            -   [Working with a Message Implementation Guideline](IntegrationAdvisor/working-with-a-message-implementation-guideline-9d1c1df.md)
                ...
                -   [Codelists](IntegrationAdvisor/codelists-a7a84b0.md)
                    -   [Working with Codelists](IntegrationAdvisor/working-with-codelists-770f7be.md)
                ...
                -   [Enabling Arbitrary Composite Ordering](IntegrationAdvisor/enabling-arbitrary-composite-ordering-46602d5.md)
                -   [Special Cases](IntegrationAdvisor/special-cases-9b595f2.md)
            -   [Simulating Message Implementation Guidelines](IntegrationAdvisor/simulating-message-implementation-guidelines-42b45c5.md)
            -   [Versioning a Message Implementation Guideline](IntegrationAdvisor/versioning-a-message-implementation-guideline-ab7de66.md)
            -   [Migrating a Message Implementation Guideline](IntegrationAdvisor/migrating-a-message-implementation-guideline-a9b12f3.md)
            -   [Deleting Message Implementation Guidelines](IntegrationAdvisor/deleting-message-implementation-guidelines-6949c3f.md)
        -   [Mapping Guidelines \(MAGs\)](IntegrationAdvisor/mapping-guidelines-mags-42124f4.md)
            -   [Creating Mapping Guidelines](IntegrationAdvisor/creating-mapping-guidelines-725d8b3.md)
                -   [Creating Standard Graphical Mapping Guidelines](IntegrationAdvisor/creating-standard-graphical-mapping-guidelines-a42920e.md)
                -   [Creating Overlay Graphical Mapping Guidelines](IntegrationAdvisor/creating-overlay-graphical-mapping-guidelines-3e550b1.md)
                -   [Creating XSLT Mapping Guidelines](IntegrationAdvisor/creating-xslt-mapping-guidelines-5f0518a.md)
            -   [Global Code Value Mappings](IntegrationAdvisor/global-code-value-mappings-fd1d3ff.md)
                -   [Versioning a Global Code Value Mapping](IntegrationAdvisor/versioning-a-global-code-value-mapping-fcbcf74.md)
            -   [Working with Mapping Guidelines \(MAGs\)](IntegrationAdvisor/working-with-mapping-guidelines-mags-0803ca6.md)
                -   [Pretransforming a Message Implementation Guideline](IntegrationAdvisor/pretransforming-a-message-implementation-guideline-b287e5e.md)
                ...
                -   [Value Transformations](IntegrationAdvisor/value-transformations-19f8374.md)
                    ...
                    -   [Working with Code Value Mappings](IntegrationAdvisor/working-with-code-value-mappings-fd8f054.md)
            ...
            -   [Working with Overlay Mapping Guidelines](IntegrationAdvisor/working-with-overlay-mapping-guidelines-e0ba4a7.md)
                -   [Matching Rules for Overlay Mapping Guidelines](IntegrationAdvisor/matching-rules-for-overlay-mapping-guidelines-efb1ec1.md)
                -   [Limitations](IntegrationAdvisor/limitations-73bec5f.md)
            -   [Simulating Mapping Guidelines](IntegrationAdvisor/simulating-mapping-guidelines-b18178b.md)
            -   [Versioning a Mapping Guideline](IntegrationAdvisor/versioning-a-mapping-guideline-11813f2.md)
            -   [Deleting Mapping Guidelines](IntegrationAdvisor/deleting-mapping-guidelines-8e3a934.md)
        ...
        -   [Runtime Artifacts](IntegrationAdvisor/runtime-artifacts-d016138.md)
            ...
            -   [Inject Mapping Artifacts to SAP Cloud Integration](IntegrationAdvisor/inject-mapping-artifacts-to-sap-cloud-integration-47ad97e.md)
        ...
        -   [Protecting Artifacts](IntegrationAdvisor/protecting-artifacts-990b84d.md)
        -   [Settings](IntegrationAdvisor/settings-4c442af.md)
