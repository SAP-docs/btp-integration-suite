...
The mapping of the persona to the authorization groups \(Neo\) or role collections \(Cloud Foundry\) is described under [Personas](personas-2937e5c.md).
...
Provides permission for the read-only persona \(see [Personas](personas-2937e5c.md)\)
...
Provides permission for the tenant administrator persona \(see [Personas](personas-2937e5c.md)\)
...
Provides permission for the business expert persona \(see [Personas](personas-2937e5c.md)\)
...
Provides permission for the integration developer persona \(see [Personas](personas-2937e5c.md)\)
