...
### Agreement Activation and Deactivation

**Activation**

You can activate a specific version of an inactive agreement, regardless of whether it's a draft version or a numbered versioned artifact. Activating a version of an agreement deploys this version to the Partner Directory and undeploys any other active versions. Only one version of an agreement can be active at a time.

**Deactivation**

You can deactivate a specific version of an active agreement, regardless of whether it's a draft version or a numbered versioned artifact. Deactivating an agreement version undeploys the selected version from the Partner Directory.

See [Activate/Deactivate Agreements](activate-deactivate-agreements-e068e37.md).
