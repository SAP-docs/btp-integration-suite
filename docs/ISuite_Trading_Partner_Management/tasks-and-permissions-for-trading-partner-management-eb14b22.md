...
Read and write access to the Partner Directory \(for example, to delete orphaned Partner Directory entries, or push content like agreements to the Partner Directory\)
...
Read user credentials and key store entries
