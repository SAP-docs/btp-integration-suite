...
The Agreement Template has a new format. The outdated templates are read-only and must be migrated to this new format to enable editing. The following procedure is for the latest template format. To migrate your outdated templates, see [Migrating Agreement Templates](migrating-agreement-templates-70c469b.md).
...
11. Now, you need to create a B2B transaction. To do so, follow the procedure mentioned in [Creating B2B Transactions](creating-b2b-transactions-e1de659.md).

    If you want to create a pass-through transaction, see [Creating a Pass-Through B2B Transaction](creating-pass-through-b2b-transactions-6dd03a4.md).
...
[Working with Trading Partner Agreements](working-with-trading-partner-agreements-9bd43c9.md "Explore and create trading partner agreements.")
