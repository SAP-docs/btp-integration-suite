...
15. Choose *Save*.
    ...
    > ### Note:  
    > To complete the system setup, maintain both *Sender* and *Receiver* communication channel details. Once you've maintained the necessary details, the *Status* of the system is set to *Completed*.

16. If the newly created communication uses an **AS2 sender adapter** or an **SFTP sender adapter**, you have to push its configuration to the partner directory before it can be used by an agreement. To push and activate your communication, change the switch button in the column *Activation Status* to *Active*.
