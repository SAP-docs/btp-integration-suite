...
41. Choose *Save*.
    ...
    > ### Note:  
    > Once saved, the agreement will be rendered read-only. To make further changes, migrate to the latest format. To know more, see [Migrating Agreements](migrating-agreements-bdcf534.md).
