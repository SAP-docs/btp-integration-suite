...
3.  Choose the *Receiver* tab and maintain the following:
    ...
    > ### Note:  
    > You only need to maintain this tab if you have enabled dead letter queue in your agreement for the receiver interchange. To know more, see [Working with Trading Partner Agreements](working-with-trading-partner-agreements-9bd43c9.md).
