...
> ### Note:  
> If you have a custom integration flow calling the sender side integration flow, it has to hand over the type system in header, and avoid using the header name reserved by the application, Trading POartner Management.
> 
...
1.  In the *Artifacts* tab, choose the <span class="SAP-icons-V5"></span> Action for the integration flow *Step 1 - Sender AS2 Communication Flow V2* and select *Configure*.
...
3.  Choose the *Receiver* tab and maintain the following parameters:
...
In the *Artifacts* tab, choose the <span class="SAP-icons-V5"></span> Action for the integration flow *Step 1 - Sender Process Direct Communication Flow V2* and then choose *Deploy*.
...
2.  Select the *Receiver* tab and maintain the following parameters:
