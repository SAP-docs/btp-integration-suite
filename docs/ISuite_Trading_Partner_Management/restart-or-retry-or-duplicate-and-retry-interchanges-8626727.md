...
# Restart or Retry, or Duplicate and Retry Interchanges
...
You need to configure a destination to store the connection information about the reprocessed integration flow.
