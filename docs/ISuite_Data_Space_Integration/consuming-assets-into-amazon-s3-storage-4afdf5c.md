...
# Consuming Assets Into Amazon S3 Storage
...
This topic describes the recommended process to trigger a contract negotiation and transfer both S3 and Azure assets to your Amazon S3 storage. For the process of transferring assets to your Azure Blob Storage, see [Consuming Assets Into Azure Blob Storage](consuming-assets-into-azure-blob-storage-0088840.md). For HTTP assets, see [Consuming HTTP Assets](consuming-http-assets-735300c.md).
...
5.  You can now transfer your assets to a destination that you specify.
