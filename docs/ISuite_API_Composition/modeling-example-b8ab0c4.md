...
![Database schema showing four entities: class, subject, teacher, and Room with their attributes.](images/Modeling_Example_1_683b7f3.png)
...
![Database schema showing four tables: school.class, school.subject, school.teacher, and school.Room with their fields and data types.](images/Modeling_Example_2_e3aad43.png)
...
![UML diagram showing association between my.new.Class and my.new.Teacher classes.](images/Modeling_Example_3_213d452.png)
...
![UML class diagram showing my.new.Teacher entity with String attributes and Association to many relationship.](images/Modeling_Example_4_bd6d332.png)
...
There are three data source entities, and `Class` is a composed projection, hiding the data sources from the consumer of the API Composition API. The first and default source entity is `school.class`. Other source entities are defined in relation to its source attributes: `subjectID` and `room`, respectively.
