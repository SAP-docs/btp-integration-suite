...
3.  There are two ways to extend a business data graph:
    ...
    -   Extending new Business Data Graph:
        1.  Follow the steps for creating a new business data graph. For more information, see [Create a Business Data Graph in SAP Integration Suite](create-a-business-data-graph-in-sap-integration-suite-42daf3b.md).
