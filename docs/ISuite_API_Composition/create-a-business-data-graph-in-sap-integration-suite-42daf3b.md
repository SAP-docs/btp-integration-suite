...
# Create a Business Data Graph in SAP Integration Suite

As a API Composition Key User, you can create a new business data graph. You can also use an existing configuration file to create a business data graph.
...
-   Assigned the role of API Composition Key User.
...
-   Set up your data sources and provided your user with authorization to access all the data sources \(destinations\) in the landscape.
    ...
    Your user needs this authorization to allow API Composition to discover the data models.
...
1.  Go to SAP Integration Suite, *Design* \> *API Composition* \> *Business Data Graphs*.
