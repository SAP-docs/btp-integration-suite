...
The illustration shows three archetypical ways of creating client applications that use API Composition. Each archetype represents somewhat different coding considerations, security requirements, and best practices.

![Diagram shows three archetypical ways of creating client applications for examples of Task, Workflow, and Extension. Each archetype represents somewhat different coding considerations, security requirements, and best practices.](images/Application_Architypes_f65da8e.png)
