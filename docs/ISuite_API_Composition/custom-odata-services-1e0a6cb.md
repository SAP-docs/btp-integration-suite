...
In addition to connecting to SAP business systems, you can set up a custom datasource that supports OData protocol to enable API Composition to communicate with your API service.

As an administrator of your OData API service, you need to configure the communication between API Composition and your business system.
...
Create a destination to enable the communication between your business system and API Composition. As the SAP BTP administrator, you need to create an HTTP destination to be able to make calls to OData APIs from API Composition. The authentication type is based on your setup for that specific business system.
