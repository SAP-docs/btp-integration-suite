...
As a Subaccount or Tenant Administrator, you need to perform various steps to use the API Composition Configuration API.
...
-   Set up your data sources and authorized your user to access all the data sources \(destinations\) in the landscape. Your user needs this authorization to allow API Composition to discover the data models.

-   Configured an entitlement for API Composition to access the API Composition Configuration API. For more information, see [Configure Entitlement for Graph](initial-setup-12ad448.md#loio12ad448225ac47049982d9faab7978a3__section_configEntitlement).
...
## Create a API Composition Service Instance
...
2.  Select the API Composition service from the dropdown menu and enter the basic information for your instance.
...
The API Composition key user must have a service binding to obtain the access credentials to consume it.
