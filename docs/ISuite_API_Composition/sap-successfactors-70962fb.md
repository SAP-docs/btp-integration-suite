<!-- loio70962fb2145e466cb94ce41ebf981d89 -->

# SAP SuccessFactors

As an SAP SuccessFactors and SAP BTP administrator, you need to set up the connectivity to API Composition and create destinations.:
...
As the SAP SuccessFactors administrator, you need to create an OAuth client that will be used to configure the trust between SAP SuccessFactors and API Composition.
...
4.  In the *Application URL* field, enter the URL of your API Composition tenant.
...
1.  In the SAP BTP cockpit, go to your subaccount in the SAP BTP, Cloud Foundry environment.
2.  Choose *Connectivity* \> *Destinations* and choose *Create* \> *From Scratch* \> *Create*. Enter the following:
...
3.  Configure the required additional properties. To do so, in the *Additional Properties* panel, choose *New Property*, and enter the following parameters:
