...
An introduction to the configuration topics of API Composition.

This section provides all the information you need to:

-   Configure API Composition in SAP Integration Suite 
