...
As an administrator for SAP S/4HANA, you need to configure the communication between API Composition and SAP S/4HANA by installing a cloud connector and creating destinations.
...
The SAP S/4HANA administrator configured the communication between API Composition and SAP S/4HANA. You know the following:
