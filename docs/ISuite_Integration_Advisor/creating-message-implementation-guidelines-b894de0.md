...
10. Choose *Create*.
    ...
    > ### Note:  
    > You can also create a MIG from the Library of Type Systems. Navigate to *Discover* \> *Type Systems*, choose the type systems based on your requirement and navigate to the *Messages* tab.
    > 
