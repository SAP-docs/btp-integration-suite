...
1.  Choose *Edit*.
    ...
    > ### Note:  
    > Ensure that the MAG you want to edit isn't **locked** by other users. The *Locked By* field displays the ID of the user who's currently editing the MAG. To unlock a MAG, you need admin rights. To learn more about the role, see [Configuring User Access to SAP Integration Suite](https://help.sap.com/viewer/51ab953548be4459bfe8539ecaeee98d/CLOUD/en-US/2c6214a3228e4b4cba207f49fda92ed4.html "Assign the required roles and role collections to users for accessing the individual capabilities.") :arrow_upper_right:.
